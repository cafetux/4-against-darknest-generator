...
data class EncounterModel(val room: RoomModel, val enemy: EnemyModel? = null, val treasures: List<TreasureModel> = emptyList(), val trap : TrapModel? = null)
...
data class TrapModel(val name: String, val level: Int, val details: List<String>)